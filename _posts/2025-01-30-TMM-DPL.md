---
title: "恭喜刘攀同学的研究工作DPL被IEEE TMM录用!
DPL has been accepted by IEEE TMM!"
...
恭喜刘攀同学的研究工作被IEEE TMM (Transactions on Multimedia)期刊录用。刘攀同学是2023级硕士研究生，由赵萌老师和我共同指导，此次被录用的论文是他攻读硕士学位的第一项研究工作，研究主题是无源域适应。TMM是IEEE在多媒体、信号处理、人工智能方向的旗舰级期刊，中科院期刊分区表一区期刊。
